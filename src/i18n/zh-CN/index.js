...
export default {
  ...
  search_device_types_placeholder: "搜索设备类型...",
  search_devices_placeholder: "搜索设备...",
  reset_search: "重置搜索",
  reset_filters: "重置筛选",
  filter_by_parent: "按父类别筛选",
  filter_by_device_type: "按设备类型筛选",
  all_device_types: "所有设备类型",
  total_categories: "总共 {count} 个类别",
  total_devices: "总共 {count} 个设备",
  total_device_types: "总共 {count} 个设备类型",
  back_to_list: "返回列表",
  back_to_device_list: "返回设备列表",
    ...
    unknown_error: "未知错误",
  fetch_device_types_failed: "获取设备类型失败",
  fetch_device_data_failed: "获取设备数据失败",
  unnamed_device_type: "未命名设备类型",
  ...
  device_management_subtitle: "管理IoT设备信息",
  device_type_management_title: "设备类型管理",
  device_type_management_subtitle: "管理IoT设备类型信息",
  ...
  confirm_delete_device_type: "确认删除设备类型",
  confirm_delete_device_type_message: "确定要删除设备类型'{name}'吗？",
  save_success: "保存成功",
  save_failed: "保存失败",
  unknown_error: "未知错误",
  unknown_date: "未知日期",
  ...
  device_serial_number_required: "设备序列号不能为空",
  device_type_required: "设备类型不能为空",
  connection_status_required: "连接状态不能为空",
  network_type_required: "网络类型不能为空",
  work_status_required: "工作状态不能为空",
  ...
  ethernet: "以太网",
  bluetooth: "蓝牙",
  device_edit_dialog_title: "编辑设备",
  add_device_dialog_title: "新增设备",
  view_device_dialog_title: "查看设备",
  device_name_placeholder: "请输入设备名称",
  device_id_placeholder: "请输入设备ID",
  location_placeholder: "请输入位置",
  notes_placeholder: "请输入备注",
  please_select_device_type: "请选择设备类型",
  please_select_connection_status: "请选择连接状态",
  please_select_working_status: "请选择工作状态",
  device_management_title: "设备管理",
  device_management_subtitle: "管理物联网设备信息",
  total_devices: "总共 {count} 个设备",
  fetch_devices_failed: "获取设备列表失败",
  confirm_delete_device: "确认删除设备",
  delete_device_success: "设备删除成功",
  delete_device_failed: "设备删除失败",
  search_devices_placeholder: "搜索设备...",
  filter_by_device_type: "按设备类型筛选",
  filter_by_connection_status: "按连接状态筛选",
  filter_by_working_status: "按工作状态筛选",
  all_device_types: "所有设备类型",
  all_connection_statuses: "所有连接状态",
  all_working_statuses: "所有工作状态",
  select_device: "请选择设备",
  device_management_description: "设备管理页面，用于管理所有物联网设备",
  view_device: "查看设备",
  edit_device: "编辑设备",
